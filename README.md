# Cross-Ark-Chat
To see how to set up the bot and settings check out the new wiki page. https://github.com/spikeydragoon/Cross-Ark-Chat/wiki

Check out the FAQ page. https://github.com/spikeydragoon/Cross-Ark-Chat/wiki/FAQ
